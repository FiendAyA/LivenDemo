...
import com.liven.demo.ext.KtxAppLifeObserver
import com.liven.demo.ext.KtxLifeCycleCallBack
import com.liven.demo.network.NetworkStateReceive

val appContext: Application by lazy { Ktx.app }

/**
 * Use to init SDKs to speed up open time
 */
